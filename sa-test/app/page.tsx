  ...
  return (
    <main className="p-8 max-w-2xl mx-auto">
      ...
      <div className="mb-8 p-4 bg-blue-100 border-2 border-blue-400 rounded-lg">
        <p className="font-semibold">현재 환경:</p>
      ...
      {/* 일반 테스트 액션 */}
      <form action={testAction} className="mb-8 p-6 border-2 rounded-lg bg-gray-50">
        <h2 className="text-xl font-semibold mb-3">📝 일반 테스트 액션</h2>
      ...
      <div className="mt-8 p-4 bg-yellow-100 border-2 border-yellow-400 rounded-lg">
        ...
        <ol className="text-sm mt-2 space-y-1 list-decimal list-inside">
          ...
          <li>요청 헤더에서 'next-action' 값을 복사하세요 (이게 Action ID)</li>
        </ol>
      </div>
    </main>
  );
